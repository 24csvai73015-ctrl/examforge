...
- **Dual AI Backends:**
  - 🖥️ **Ollama (Local):** Run 100% offline, private, and free using local models like `llama3` or `qwen`. Auto-detects installed models.
  - ☁️ **OpenAI (Cloud):** Use powerful models like `gpt-4o-mini` or `gpt-4o` for maximum quality and speed via API key.
...
## 🧪 Testing with TestGrid

ExamForge can be tested using TestGrid to validate application workflows and UI behavior across browsers and devices.
